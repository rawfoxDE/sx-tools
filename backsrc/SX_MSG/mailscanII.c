...
void mailscan(int scanflag)
{
        ...
        char confname[45],oldconfname[45],newbuf[256];                           
    ...
    // switch the gfx                                   // oldbase     - needed to stop reading msgbases in conf   
 	...
 	{                                               // fhc         - filehandle conferences
                ...
                {                                               
                        ...
                        PS("\n\r\n\r[33m---- ---------- ------ - ------------------------- ----------------------- ----");
                        sprintf(buf,"[1;31;44m\n\r  Messages visited : [37m%-5ld  [31mMessages written : [37m%-4s    [31mTotal New : [37m%-4ld        [0m", totalmsgs, newbuf, totalnew);                    
                        PS(buf);
                        PS("\n\r[33m--------- ------------------------- ------ ---------------------------- -------");
                                ...
                                {    
                                        ...
                                        if(LRP!=msg.number)                 // new mail found !
                                        {
                                                ...
                                                if(themsg.String[0]=='y')
                                                {
                                                        ...
                                                        SXFunction(73,buf); // join the msgbase with new mail
                                               
                                                        sprintf(buf,"%ld",LRP+1);
                                                        SXFunction(72,buf);  // read the new mail
                                                        PS("\n\r                   ");
